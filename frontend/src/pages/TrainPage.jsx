    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-500 to-indigo-500 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-3xl w-full">
        ...
        <div className="mb-6 flex items-center">
          ...
          />
          <label htmlFor="automl" className="text-gray-800 font-semibold">
            Enable AutoML
          </label>
        </div>
        ...
        {!automl && (
          <div className="mb-6">
            <label className="block mb-2 font-semibold text-gray-800">Select Category:</label>
            <select
              className="border-2 border-purple-500 rounded w-full p-3 focus:outline-none focus:ring-2 focus:ring-purple-600"
              value={selectedCategory}
              onChange={(e) => {
                setSelectedCategory(e.target.value);
                setSelectedModel('');
        ...
        {/* Model Selection (only when AutoML is off) */}
        {!automl && (
          <div className="mb-6">
            <label className="block mb-2 font-semibold text-gray-800">Select Model:</label>
            <select
        ...
        {/* Target Column Input (only for supervised models) */}
        {selectedCategory === "supervised" && (
          <div className="mb-6">
            <label className="block mb-2 font-semibold text-gray-800">Enter Target Column:</label>
            <input
        ...
        {/* Hyperparameter Tuning Options (only when AutoML is off) */}
        {!automl && (
          <div className="mb-6">
            <label className="block mb-2 font-semibold text-gray-800">Select Tuner Type:</label>
            <select
              className="border-2 border-purple-500 rounded w-full p-3 focus:outline-none focus:ring-2 focus:ring-purple-600"
              value={tunerType}
        ...
        {/* Custom Hyperparameters (only when AutoML is off) */}
        ...
        <div className="flex justify-center mt-8">
          <button
            ...
            className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 rounded disabled:opacity-50 transition-all duration-300 ease-in-out"
          >
            Start Training
          </button>
        </div>
        ...
        <div className="flex justify-center mt-6">
          <button
            ...
            className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-6 rounded transition duration-300"
          >
            Back to Dashboard
          </button>
        </div>
